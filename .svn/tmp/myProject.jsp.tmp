...
<button id="addMember" type="button" hidden="hidden" class="btn btn-default btn-sm" data-toggle="modal" data-target="#myModal"></button>
				...
				<div id="myModal" class="modal fade" role="dialog">
				  <div class="modal-dialog">
				    ...
				    <!-- Modal content-->
				    <div class="modal-content" style="padding:30px; border-top: 5px solid #f39c12; border-radius: 10px;">
					   ...
					   <div class="reviewRating">
					    <div>
						    ...
						    <form name="myform"  class="myform" method="post" action="./save">
						    	<table class="reviewTable" >
						    		<tr>
						    			<td style="width:50%">칸반 기능은 어떠셨나요 ? </td>
						    			<td> <fieldset>
						...
						<div>
							...
							<form name="myform" class="myform" method="post" action="./save">
								...
								<table class="reviewTable">
						    		<tr>
						    			<td style="width:50%">간트차트 기능은 어떠셨나요 ? </td>
										<td>		
										    <fieldset>
						...
						<div>
							<form name="myform" class="myform" method="post" action="./save">
								...
								<table class="reviewTable" >
						    		<tr>
						    			<td style="width:50%">업무 기능은 어떠셨나요 ? </td>
					...
					<div>
						...
						<form name="myform" class="myform" method="post" action="./save">
							<table class="reviewTable" >
					    		<tr>
					    			<td style="width:50%">코드리뷰 기능은 어떠셨나요 ? </td>
					...
					<div>
						<form name="myform" class="myform" method="post" action="./save">
							<table class="reviewTable" >
					    		<tr>
					    			<td style="width:50%">채팅 기능은 어떠셨나요 ? </td>
					...
					<div>
						...
						<form name="myform" class="myform" method="post" action="./save">
							...
							<table class="reviewTable" >
					    		<tr>
					    			<td style="width:50%">깃허브 기능은 어떠셨나요 ? </td>
