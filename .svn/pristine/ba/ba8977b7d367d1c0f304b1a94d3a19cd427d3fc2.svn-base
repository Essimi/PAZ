...
public class CodeContent {
	...
	public String gitCodeConversion(@RequestParam(value = "codeText", required = false) String codeText, 
									...
									@AuthenticationPrincipal(expression="authMember") MemberVO authMember, Model model) throws IOException {
		...
		conn.setRequestProperty("Authorization", "token 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");
