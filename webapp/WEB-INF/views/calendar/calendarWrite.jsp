          ...
          <div class="card card-primary">
            ...
            <form action="${pageContext.request.contextPath}/calendar/calendarInsert.do" method="post">
              <div class="form-group">
                ...
                <input type="text" id="inputName" class="form-control" name = "scheduleName">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="date" id="inputClientCompany" class="form-control" name = "scheduleStart">
              </div>
                <div class="form-group">
                <label for="inputClientCompany">마감날짜</label>
                <input type="date" id="inputClientCompany" class="form-control" name = "scheduleDeadline">
              </div>
