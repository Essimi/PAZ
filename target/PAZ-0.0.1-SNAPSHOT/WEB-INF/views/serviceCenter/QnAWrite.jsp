					...
					<div class="row">
						<div class="col-12">	
							...
							<div class="float-right">
								<c:if test="${authMember.memId ne 'admin'}">
				 					<input type = "button" id = "qnaInsert" class = "btn btn-info" style = "margin-top: -70px;" value = "TEST">
								</c:if>
								
								<c:if test="${authMember.memId eq 'admin'}">
				 					<input type = "button" id = "answerInsert" class = "btn btn-info" style = "margin-top: -70px;" value = "TEST">
								</c:if>
							</div>
								...
								<div class="card card-primary card-outline">
									<div class="card-body p-0">
										<div class="mailbox-read-info">
											...
											<br> <form:input id = "insertTitle" path="qandaTitle" type="text" class="form-control" placeholder="제목을 입력해주세요"/> <br>
